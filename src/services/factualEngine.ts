// Pure factual logic engine for Resume/JD parsing, matching, plan generation, and rubric evaluation
// Compatible with both browser client-side execution and server-side runtimes.
 ...
 */
export function factualBriefGenerator(
